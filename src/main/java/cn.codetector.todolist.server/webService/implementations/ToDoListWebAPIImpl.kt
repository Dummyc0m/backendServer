package cn.codetector.todolist.server.webService.implementations

import cn.codetector.todolist.server.data.configuration.DatabaseConfiguration.db_prefix
import cn.codetector.todolist.server.data.user.WebUser
